...
namespace Platform.Data.Doublets.Gql.Schema.Types.Input
{
    public class StringComparisonExpressionInputType : InputObjectGraphType<StringComparisonExpression>
    {
        public StringComparisonExpressionInputType()
        {
            ...
            Field(x => x._in, nullable: true, type: typeof(List<NonNullGraphType<StringGraphType>>));
            ...
            Field(x => x._nin, nullable: true, type: typeof(List<NonNullGraphType<StringGraphType>>));
