...
namespace Platform.Data.Doublets.Gql.Schema.Types.Input
{
    ...
    public class BooleanExpressionBooleanExpressionInputType : InputObjectGraphType<MappedType>
    {
        public BooleanExpressionBooleanExpressionInputType()
        {
            ...
            Field(x => x._and, true, typeof(ListGraphType<BooleanExpressionBooleanExpressionInputType>));
            Field(x => x._not, true, typeof(BooleanExpressionBooleanExpressionInputType));
            Field(x => x._or, true, typeof(ListGraphType<BooleanExpressionBooleanExpressionInputType>));
            Field(x => x.gql, true, typeof(StringComparisonExpressionInputType));
            ...
            Field(x => x.sql, true, typeof(StringComparisonExpressionInputType));
        }
    }
}
