...
namespace Platform.Data.Doublets.Gql.Schema.Types
{
    ...
    public class LinksType : ObjectGraphType<MappedType>
    {
        public LinksType()
        {
            ...
            Field<NonNullGraphType<ListGraphType<NonNullGraphType<LinksType>>>>(nameof(MappedType.@in), null,
                LinksQuery.Arguments, ResolveIn);
            Field<NonNullGraphType<LinksAggregateType>>(nameof(MappedType.in_aggregate), null, LinksQuery.Arguments,
                ResolveInAggregate);
            Field<NonNullGraphType<ListGraphType<NonNullGraphType<LinksType>>>>(nameof(MappedType.@out), null,
                LinksQuery.Arguments, ResolveOut);
            Field<NonNullGraphType<LinksAggregateType>>(nameof(MappedType.out_aggregate), null, LinksQuery.Arguments,
                ResolveOutAggregate);
